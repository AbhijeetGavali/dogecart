...
router.put("/:email", async (req, res) => {
  ...
  try {
    ...
    console.log(
      `http://${process.env.WEBSITEURL}/api/account/users/reset-password/${email}/${authtoken}`
    );
    var htmlData = `http://${process.env.WEBSITEURL}/api/account/users/reset-password/${email}/${authtoken}`;
    var props = {
      MAIL_TO: email,
